...
urlpatterns = patterns('vtplanner.controller.aggregate',
    url(r'^aggregate/create/$', 'aggregate_crud', name='vtplanner_aggregate_create'),
    url(r'^aggregate/(?P<agg_id>\d+)/edit/$', 'aggregate_crud', name='vtplanner_aggregate_edit'),
)

urlpatterns = urlpatterns + patterns('vtplanner.controller.GUIdispatcher',
