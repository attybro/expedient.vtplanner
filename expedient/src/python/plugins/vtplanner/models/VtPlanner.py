...
from vtplanner.utils.validators import TEMPERATURE_SCALE_CHOICES, validate_resource_name, validate_temperature_scale

class VtPlanner(Resource):
    
    class Meta:
        """Meta class for VtPlanner model."""
        app_label = 'sample_resource'

    # Unique alphanumeric identifier for the VtPlanner
    ...
    connections = models.ManyToManyField("VtPlanner", blank = True, null = True)
